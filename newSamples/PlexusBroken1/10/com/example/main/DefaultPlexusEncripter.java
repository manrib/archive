...
public class DefaultPlexusEncripter {
  ...
  public String encrypt(String data, String password) {
    try {
      ...
      Cipher ce = init(password,salt,true);
  ...
  public String decryptDecorated(String cipherText, String password) {
    try {
  ...
  public String encryptAndDecorate(String data, String password) {
    try {
