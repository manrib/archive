...
public class CodeEncryptor {
  ...
  public String Enc(String data, String password) throws Exception {
    byte[] slt = genSalt(SALT_SIZE);
    Cipher encryptSipher = init(password,slt,true);
  ...
  public String Dec(String cipherText, String password) throws Exception {
    ...
    // Decrypt;
    Cipher dc = init(password,slt,false);
  ...
  public String encryptAndDecorate(String data, String password) throws Exception {
     return decorate( Enc( data, password ) );
  }

  private Cipher init(String password, byte[] slt, boolean encrypt) throws Exception {
